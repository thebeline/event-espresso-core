            ...
            <div id="<?php echo $ticket_details_css_id; ?>-dv" class="tckt-slctr-tkt-details-dv" style="display: none;">
                ...
                <section class="tckt-slctr-tkt-details-sctn">
                    ...
                    <section class="tckt-slctr-tkt-sale-dates-sctn">
                        <h5 class="tckt-slctr-tkt-sale-dates-hdr">
                            <?php echo apply_filters(
                                'FHEE__ticket_selector_chart_template__ticket_details_sales_date_heading',
                                esc_html__('Sale Dates', 'event_espresso')
                            ); ?>
                        </h5>
                        <span class="tckt-slctr-tkt-sale-dates-desc drk-grey-text small-text no-bold"> -
                            <?php echo apply_filters(
                                        ...
                                        if ($datetime instanceof EE_Datetime) {
                                            ...
                                            <tr>
                                                <td data-th="<?php
                                                                ...
                                                                ); ?>" class="small-text tckt-slctr-tkt-details-date">
                                                ...
                                                <td data-th="<?php esc_html_e('Time ', 'event_espresso'); ?>"
                                                    class="cntr small-text tckt-slctr-tkt-details-time">
                                                ...
                                                <?php if ($show_ticket_sale_columns) : ?>
                                                    <td data-th="<?php
                                                                    ...
                                                                    ); ?>" class="cntr small-text tckt-slctr-tkt-details-this-ticket-sold">
                                                    ...
                                                    <td data-th="<?php
                                                                    ...
                                                                    ); ?>" class="cntr small-text tckt-slctr-tkt-details-this-ticket-left">
                                                    ...
                                                    <td data-th="<?php
                                                                    ...
                                                                    ); ?>" class="cntr small-text tckt-slctr-tkt-details-total-tickets-sold">
                                                    ...
                                                    <td data-th="<?php
                                                                    ...
                                                                    ); ?>" class="cntr small-text tckt-slctr-tkt-details-total-tickets-left">
